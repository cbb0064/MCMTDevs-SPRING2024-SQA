...
def getDataLoadCount(py_file):
    ...
    for def_ in func_def_list:
        ...
        if (class_name == constants.TORCH_KW) and (func_name == constants.LOAD_KW):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_DATA_LOAD, func_line, py_file
                )
            )
        ...
        elif (class_name == constants.LATEST_BLOB_KW) and (
            func_name == constants.DOWNLOAD_TO_FILENAME_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.BLOB_KW) and (
            func_name == constants.UPLOAD_FROM_FILENAME_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.COCO_GT_KW) and (
            func_name == constants.LOADRES_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.DATA_LOADER_FACTORY_KW) and (
            func_name == constants.GET_DATA_LOADER_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.DATASET_KW) and (
            func_name == constants.TENSOR_SLICE_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.SP_MODEL_KW) and (
            func_name == constants.LOAD_CAPITAL_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.TAGGING_DATA_LOADER_KW) and (
            func_name == constants.LOAD_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.DATA_UTILS_KW) and (
            func_name == constants.LOAD_CELEBA_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.AUDIO_KW) and (
            func_name == constants.LOAD_WAV_KW
        ):
            data_load_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.REPLAY_BUFFER_KW) and (
            func_name == constants.LOAD_KW
        ):
            data_load_count += 1
            print(
...
def getDataLoadCountc(py_file):
    ...
    for func_ in func_assign_list:
        ...
        if (func_name == constants.LOAD_RANDOMLY_AUGMENTED_AUDIO_KW) and (
            len(func_arg_list) > 0
        ):
            data_load_countc += 1
            print(
        ...
        elif (func_name == constants.LOAD_GENERIC_AUDIO_KW) and (
            len(func_arg_list) > 0
        ):
            data_load_countc += 1
            print(
        ...
        elif (func_name == constants.LOAD_IMAGE_DATASET_KW) and (
            len(func_arg_list) > 0
        ):
            data_load_countc += 1
            print(
        ...
        elif (func_name == constants.LOAD_ATTRIBUTE_DATASET_KW) and (
            len(func_arg_list) > 0
        ):
            data_load_countc += 1
            print(
...
def getModelLoadCounta(py_file):
    ...
    for def_ in func_def_list:
        ...
        if (class_name == constants.DEEP_SPEECH_KW) and (
            func_name == constants.LOAD_MODEL_PACKAGE_KW
        ):
            model_load_counta += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_MODEL_LOAD, func_line, py_file
                )
            )

        elif (class_name == constants.MODELS_KW) and (
            func_name == constants.LOAD_MODEL_KW
        ):
            model_load_counta += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.MODEL_KW) and (
            func_name == constants.LOAD_STATE_DICT_KW
        ):
            model_load_counta += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.NETWORK_KW) and (
            func_name == constants.LOAD_NET_KW
        ):
            model_load_counta += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.VGG_KW) and (
            func_name == constants.LOAD_FROM_NPY_FILE_KW
        ):
            model_load_counta += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.CAFFE_PARSER_KW) and (
            func_name == constants.READ_CAFFE_MODEL_KW
        ):
            model_load_counta += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
...
def getModelLoadCountc(py_file):
    ...
    for func_ in func_assign_list:
        ...
        elif (func_name == constants.LOAD_PREVIOUS_VALUES_KW) and (
            len(func_arg_list) > 0
        ):
            model_load_countc += 1
            print(
...
def getDataDownLoadCount(py_file):
    ...
    for def_ in func_def_list:
        ...
        if (class_name == constants.WGET_KW) and (func_name == constants.DOWNLOAD_KW):
            ...
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_DATA_DLOAD, func_line, py_file
                )
            )

        elif (class_name == constants.REQUEST_KW) and (
            func_name == constants.URL_OPEN_KW
        ):
            data_download_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
        ...
        elif (class_name == constants.MODEL_ZOO_KW) and (
            func_name == constants.LOAD_URL_KW
        ):
            data_download_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
...
def getModelFeatureCount(py_file):
    ...
    for feature_ in feature_list:
        ...
        if (class_name == constants.DATA_KW) and (
            feature_name == constants.HP_BATCH_SIZE_KW
        ):
            model_feature_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_MODEL_FEATURE, feature_line, py_file
                )
            )
        ...
        for var_name in lhs:
            if constants.LABEL_KW in var_name:
                if (func_name == constants.READ_H5FILE_KW) and (len(func_arg_list) > 0):
                    ...
                    print(
                        constants.CONSOLE_STR_DISPLAY.format(
                            constants.CONSOLE_STR_MODEL_LABEL, func_line, py_file
                        )
                    )
                ...
                elif (func_name == constants.LOAD_DATA_AND_LABELS_KW) and (
                    len(func_arg_list) > 0
                ):
                    model_label_count += 1
                    print(
                ...
                elif (func_name == constants.CREATE_DATASET_KW) and (
                    len(func_arg_list) > 0
                ):
                    model_label_count += 1
                    print(
...
def getModelLabelCountb(py_file):
    ...
    for assign_ in func_assign_list:
        ...
        if constants.LABEL_KW in lhs:
            ...
            if (
                (var_s == constants.SENT_KW)
                and (var_d == constants.SENT_KW)
                and (rhs_var_iter == constants.INPUT_BATCH_LIST_KW)
            ):
...
def getModelOutputCount(py_file):
    ...
    for def_ in func_def_list:
        ...
        if (class_name == constants.DATA_KW) and (
            func_name == constants.SHOW_DATA_SUMMARY_KW
        ):
            model_output_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_MODEL_OUTPUT, func_line, py_file
                )
            )
...
def getModelOutputCountc(py_file):
    ...
    for func_ in func_assign_list:
        ...
        elif (func_name == constants.CLASSIFICATION_LOSS_KW) and (
            len(func_arg_list) > 0
        ):
            model_output_countc += 1
            print(
...
def getDataPipelineCount(py_file):
    ...
    for def_ in func_def_list:
        ...
        if (
            (class_name == constants.ARG_PARSE_KW)
            and (func_name == constants.ARGUMENT_PARSER_KW)
            and (len(arg_call_list) > 0)
        ):
            data_pipeline_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_PIPELINE, func_line, py_file
                )
            )
...
def getDataPipelineCountc(py_file):
    ...
    for func_ in func_assign_list:
        ...
        if (func_name == constants.GET_CONFIGS_FROM_PIPELINE_FILE_KW) and (
            len(func_arg_list) > 0
        ):
...
def getDataPipelineCountd(py_file):
    ...
    for feature_ in feature_list:
        ...
        if (class_name == constants.PIPELINE_CONFIG_KW) and (
            feature_name == constants.MODEL_KW
        ):
            data_pipeline_countd += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_PIPELINE, feature_line, py_file
                )
            )
...
def getEnvironmentCount(py_file):
    ...
    for def_ in func_def_list:
        ...
        if (
            (class_name == constants.WRAPPED_ENV_KW)
            and (func_name == constants.STEP_KW)
            and (len(arg_call_list) > 0)
        ):
            environment_count += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_REL_ENV, func_line, py_file
                )
            )

        elif (
            (class_name == constants.ENV_KW)
            and (func_name == constants.STEP_KW)
            and (len(arg_call_list) > 0)
        ):
            environment_count += 1
            ...
            (class_name == constants.GYM_KW)
            and (func_name == constants.MAKE_KW)
            and (len(arg_call_list) > 0)
        ):
            environment_count += 1
            print(
...
def getEnvironmentCountb(py_file):
    ...
    for feature_ in feature_list:
        ...
        if (class_name == constants.OBSERVATION_SPACE_KW) and (
            feature_name == constants.SHAPE_KW
        ):
            environment_countb += 1
            print(
                constants.CONSOLE_STR_DISPLAY.format(
                    constants.CONSOLE_STR_REL_ENV, feature_line, py_file
                )
            )

        elif (class_name == constants.ACTION_SPACE_KW) and (
            feature_name == constants.SHAPE_KW
        ):
            environment_countb += 1
            print(
...
def checkLoggingLibrary(py_file):
    ...
    for import_ in import_list:
        ...
        if (
            (library_ == constants.LOGGING_KW)
            or (library_ == constants.TENSORFLOW_KW)
            or (library_ == constants.SYMNET_KW)
        ):
            # print(library_)
            return True
        else:
